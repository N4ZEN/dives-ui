...
const Marinelife = ({parentCallback, MarineLifee}) => {
    ...
    const renderSelectedItems = ({item}) => {
        return(
            <View style= {{flexDirection : 'row', borderColor: COLORS.lightGray2, borderWidth: 2, 
            justifyContent: 'space-between', borderRadius: 6}}>
                ...
                <TouchableOpacit onPress= {() => onChangeValue(item)}  style = {{backgroundColor: COLORS.lightGray1, borderRadius: 6, 
    ...
    return (
        <View>
            ...
            <View style = {{borderColor: COLORS.lightGray1, borderWidth: 1.5, borderRadius: 8,
                ...
                <View>
                    <View>
                    <TouchableOpacity onPress = {() => setopenspecies(true)}  style = {{backgroundColor: COLORS.lightblue1, borderRadius: 10, 
                    flexDirection: 'row', justifyContent: 'space-between', marginVertical: 10, marginHorizontal: 3}}> 
                        <Text style = {{...styles.labelStyles, fontWeight: 'bold', paddingVertical: 10, paddingLeft: 20, 
                        color: COLORS.white}}>Add Marine Life</Text>
